...
class Seq2SeqNERModel(L.LightningModule):
...
if __name__ == "__main__":
    ...
    # 使用示例
    hyperargs = dict(
                    data_path="data/aishell_ner",\
                    model_name_or_path = "cache/bart-large",\
                    wandb_project_name = "Seq2seqbaseline",
    ...
    model  = Seq2SeqNERModel(**hyperargs)
    datamodule = Seq2SeqNERDataModule(**hyperargs)
    # logger = TensorBoardLogger("lightning_logs", name="dev_test_model",default_hp_metric=False)
